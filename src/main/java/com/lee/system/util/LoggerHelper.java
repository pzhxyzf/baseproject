...
public class LoggerHelper {
	 ...
	 * 构造方法，初始化Log4j的日志对象
	 */
	private LoggerHelper(org.apache.log4j.Logger log4jLogger) {
		logger = log4jLogger;
	}
	...
	public static LoggerHelper getLogger(Class classObject) {
		return new LoggerHelper(org.apache.log4j.Logger.getLogger(classObject));
	}
	 ...
	 * @return Logger对象
	 */
	public static LoggerHelper getLogger(String loggerName) {
		return new LoggerHelper(org.apache.log4j.Logger.getLogger(loggerName));
	}
	...
	public boolean equals(LoggerHelper newLogger) {
