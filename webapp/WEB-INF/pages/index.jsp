...
<html lang="en">
	<head>
		...
		<script src="<%=basePath %>common/js/jquery-1.9.1.min.js" type="text/javascript"></script>       
		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='<%=basePath %>common/assets/js/jquery.mobile.custom.min.js'>"+"<"+"script>");
		</script>
		...
		<!--[if lte IE 8]>
		  <script src="<%=basePath %>common/assets/js/excanvas.min.js"></script>
		<![endif]-->
		<script src="<%=basePath %>common/assets/js/ace-elements.min.js"></script>
		<script src="<%=basePath %>common/assets/js/ace.min.js"></script>
        ...
        <script src="<%=basePath %>common/js/jquery.nicescroll.js" type="text/javascript"></script>
...
<script type="text/javascript">	
 ...
 jQuery(document).ready(function(){ 	
    ...
    $(document).on('click','.iframeurl',function(){
                ...
                $("#p_a_title").html(pdom.find(".menu-text").html());
                $("#p_li_icon").attr("class",pdom.find("i").attr("class"));
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small>					
						<%-- <img src="<%=basePath %>common/images/logo.png" width="470px"> --%>
						</small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
               ...
               <ul class="nav ace-nav">	
				...
				<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
				 <li><a href="javascript:void(0)" name="<%=basePath %>user/toPersonalInfo" title="个人信息" class="iframeurl"><i class="icon-user"></i>个人信息</a></li>
				 <li class="divider"></li>
...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
				     <li class="home"><a href="javascript:void(0)" name="<%=basePath %>menu/toAny?path=home" class="iframeurl" title=""><i class="icon-home"></i><span class="menu-text"> 系统首页 </span></a></li>
					   <c:forEach var="m" items="${menu}"> 
					   			<li>
					   				<a href="#" class="dropdown-toggle"><i class="${m.menuIcon }"></i><span class="menu-text"  >${m.menuName }</span><b class="arrow icon-angle-down"></b></a>
									<ul class="submenu">
										<c:forEach var="n" items="${m.nexts}"> 
											<li class="home"><a href="javascript:void(0)" name="<%=basePath %>${n.menuUrl}" title="${n.menuName}"  class="iframeurl"><i class="${n.menuIcon }"></i>${n.menuName }</a></li>
										</c:forEach>
									</ul>	
								</li>
						</c:forEach> 
	        ...
	        cursorborderradius:"5px"  
                ...
                <script type="text/javascript">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								<i class="icon-home home-icon" id="p_li_icon"></i>
								<a href="#" id="p_a_title">系统首页</a>
							</li>
                 ...
                 <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="<%=basePath %>menu/toAny?path=home">  </iframe>
