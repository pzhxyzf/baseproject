...
<body>
	       ...
	       <div class="search_style" >
					<form>
						<ul class="search_content clearfix">
							 <li><label >备品名称:</label><input id="query_name" type="text"  class="text_add" /></li>
							 <li><label >规格参数:</label><input id="query_arg" type="text"  class="text_add" /></li>
			...
			<div class="border clearfix">
		       <span class="l_f">
		        <shiro:hasPermission name="oam:back:add"><a  onclick="add()"  href="#" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i>新增</a> </shiro:hasPermission>
		       </span>
		     </div>
	...
	<form class="form-horizontal clearfix" role="form" id="addForm" style="display: none;width: 95%" >
	  ...
	  <div class="form-group">
	    <label   class="col-sm-3 control-label"><span  style="color: red">*</span>备品名称:</label>
	    <div class="col-sm-6">
	   ...
	   <div class="form-group">
	    ...
	    <div class="col-sm-6">
	      <input  class="form-control"   name="arg"  >
	    </div>
	  </div>
	  <div class="form-group">
	    <label   class="col-sm-3 control-label">数量:</label>
	    <div class="col-sm-6">
	      <input  class="form-control"   name="num" number="true">
	    </div>
	  </div>
	   <div class="form-group">
	    <label   class="col-sm-3 control-label">购买日期:</label>
	    <div class="col-sm-6">
	      <input  class="form-control  laydate-icon"   name="buytime" id="buytime">
	    </div>
	  </div>
	   <div class="form-group">
 ...
 $(function(){
		//初始化列表
	 	oTable =  $('#oTable').DataTable( {
	        "ajax":  {
	        	"url":basePath+"back/selectAllPage",
	        	"type" : "POST",
	        	"data":function ( params ) {
	        		params.name = $("#query_name").val();
	        		params.arg = $("#query_arg").val();
	            }
	        },
	        "serverSide" : true,
	        "processing" : true,
	        ...
	        "columns": [
	            {"title": "主键", "data": "id" },
	            {"title": "序号",  "data": "seq"},
	            {"title": "备品名称",  "data": "name"},
	            {"title": "规格参数",  "data": "arg"},
	            {"title": "数量",  "data": "num"},
	            {"title": "购买日期",  "data": "buytime"},
	            {"title": "质保",  "data": "quality"},
