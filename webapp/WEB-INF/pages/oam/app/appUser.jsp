...
<body>
	<div class="border clearfix">
		       <span class="l_f">
		        <shiro:hasPermission name="oam:appuser:add"><a  onclick="add()"  href="#" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i>新增</a> </shiro:hasPermission>
		       </span>
	 </div>
	...
	<form class="form-horizontal clearfix" role="form" id="addForm" style="width: 95% ;display: none;" >
	  ...
	  <input type="hidden" name="appId" id="appId"  value="${user.appId}">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-6">
	      <input  class="form-control"  name="role"  value="${user.role}">
	    </div>
	  </div>
	  <div class="form-group">  
...
$(function(){
	//初始化列表
 	oTable =  $('#oTable').DataTable( {
        "ajax":  {
        	"url":basePath+"appuser/selectAllPage",
        	"type" : "POST",
        ...
        "columns": [
            ...
            {"title": "备注",  "data": "remark" },
            {
                ...
                "data":           null,
                "defaultContent": 
                				  '<shiro:hasPermission name="oam:appuser:alter"><a title="编辑" href="javascript:;"  onclick="alter(this)"  class="btn   btn-xs  btn-info" ><i class="glyphicon glyphicon-edit"></i></a></shiro:hasPermission>'+
                    			  '<shiro:hasPermission name="oam:appuser:del"><a title="删除" href="javascript:;"  onclick="del(this)"  class="btn   btn-xs  btn-danger" ><i class="glyphicon glyphicon-trash"></i></a></shiro:hasPermission>'
            }
        ],   
        "columnDefs": [
                            {
